...
<table>
  <tr>
    <td align="center"><a href="https://jade314.tistory.com/"><img src="https://avatars.githubusercontent.com/u/40026846?v=4" width="100px;" alt=""/><br /><sub><b><% _.size(<%= options.pR %>); %></b></sub><sub><b><% _.toString(<%= options.pRCountLang %>); %> </b></sub></a></td>
  </tr>
</table>
